...
const zh = {
  ...
  // ── 企业匹配 (三蛋蛋企业库) ──
  matchPeopleTab: '人脉匹配',
  matchCompanyTab: '企业匹配',
  companyMatchTitle: '企业匹配 · 找潜在买家',
  companyMatchSubtitle: '输入您的企业信息，从1000万企业库中匹配潜在买家',
  companyQuotaLabel: '今日剩余配额',
  companyNameLabel: '公司名称',
  companyNamePlaceholder: '请输入您的公司名称(必填)',
  companyNameRequired: '请填写公司名称',
  productLabel: '主营产品',
  productPlaceholder: '您卖什么？如：养老服务机器人',
  businessLabel: '主营业务',
  businessPlaceholder: '研发生产销售...',
  typicalCustomersLabel: '典型客户',
  typicalCustomersPlaceholder: '如：养老院、护理院',
  companyMatchParamRequired: '产品/业务/典型客户至少填一项',
  searchCompanyMatch: '开始匹配',
  companyResultCount: '找到潜在买家 ',
  allianceBadge: '联盟企业',
  loadMore: '加载更多',
  companyMatchEmpty: '暂无匹配结果，请调整信息后重试',
  companyMatchFailed: '匹配失败，请稍后重试',
...
const en = {
  ...
  loadingText: 'Loading...',
  // ── Company Match (Transphee 10M company DB) ──
  matchPeopleTab: 'People Match',
  matchCompanyTab: 'Company Match',
  companyMatchTitle: 'Company Match · Find Buyers',
  companyMatchSubtitle: 'Input your company info to find potential buyers from 10M company DB',
  companyQuotaLabel: 'Quota left today',
  companyNameLabel: 'Company Name',
  companyNamePlaceholder: 'Your company name (required)',
  companyNameRequired: 'Company name is required',
  productLabel: 'Product',
  productPlaceholder: 'What do you sell? e.g. elderly care robot',
  businessLabel: 'Business',
  businessPlaceholder: 'R&D, production, sales...',
  typicalCustomersLabel: 'Typical Customers',
  typicalCustomersPlaceholder: 'e.g. nursing homes, care centers',
  companyMatchParamRequired: 'Fill product/business/customers at least one',
  searchCompanyMatch: 'Start Matching',
  companyResultCount: 'Buyers found: ',
  allianceBadge: 'Alliance',
  loadMore: 'Load more',
  companyMatchEmpty: 'No results, please adjust and retry',
  companyMatchFailed: 'Match failed, please retry later',
