...
class TestTrustNetwork:
    ...
    async def test_add_duplicate_trust(self, client, auth_headers, test_user, test_db, second_user):
    ...
    async def test_remove_trust(self, client, auth_headers, test_user, test_db, second_user):
