...
class TestRateLimiter:
    ...
    async def test_headers_present_on_success(self):
        ...
        assert headers[b"x-ratelimit-limit"] == b"100"
    ...
    async def test_rate_limit_exceeded_returns_429(self):
        ...
        assert b"retry-after" in rsp_headers
        assert b"x-ratelimit-remaining" in rsp_headers
        assert rsp_headers[b"x-ratelimit-remaining"] == b"0"
