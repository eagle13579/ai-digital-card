...
interface OptimizeData {
  ...
  keyword_coverage: { score: number; matched_keywords: string[]; suggested_keywords: string[] };
...
const WRITE_PURPOSES: { key: WritePurpose; icon: React.ReactNode }[] = [
  { key: 'bio', icon: <FileText className="w-4 h-4" /> },
  { key: 'company', icon: <Building2 className="w-4 h-4" /> },
  { key: 'recommendation', icon: <Star className="w-4 h-4" /> },
  { key: 'slogan', icon: <Quote className="w-4 h-4" /> },
];
